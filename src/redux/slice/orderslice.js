...
export const getorders = createAsyncThunk("order/getorders", () => {
    return fetch("https://e-commerce-e0556-default-rtdb.firebaseio.com/orders.json")
...
export const { detailofselectedorder, calcearning, addorders } = orderslice.actions
